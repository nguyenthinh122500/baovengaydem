...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [437], {
        ...
        1474: (e, t, n) => {
            ...
            class _default extends elementorModules.Module {
                constructor() {
                    super(), elementorFrontend.elementsHandler.attachHandler("loop-grid", (() => n.e(985).then(n.bind(n, 4098))), "post"), elementorFrontend.elementsHandler.attachHandler("loop-grid", (() => n.e(149).then(n.bind(n, 9491))), "post")
                }
            }
            t.default = _default
        },
