        ...
        8208: (e, t, s) => {
            ...
            class TOCHandler extends elementorModules.frontend.handlers.Base {
                ...
                getContainer() {
                    ...
                    return jQuery(s.selectors.postContentContainer)
                }
                bindEvents() {
                    const e = this.getElementSettings();
                ...
                getNestedLevel(e) {
                    ...
                    let l = `<${t.listWrapperTag} class="${t.classes.listWrapper}">`;
                    for (; this.listItemPointer < this.headingsData.length;) {
                        const o = this.headingsData[this.listItemPointer];
                        let a = t.classes.listItemText;
                        if (0 === o.level && (a += " " + t.classes.firstLevelListItem), e > o.level) break;
                        if (e === o.level) {
                            l += `<li class="${t.classes.listItem}">`, l += `<div class="${t.classes.listTextWrapper}">`;
                            let r = `<a href="#${o.anchorLink}" class="${a}">${o.text}</a>`;
                            "bullets" === s.marker_view && i && (r = `${n}${r}`), l += r, l += "</div>", this.listItemPointer++;
                            const h = this.headingsData[this.listItemPointer];
                            h && e < h.level && (l += this.getNestedLevel(h.level)), l += "</li>"
                        }
                    }
                    return l += `</${t.listWrapperTag}>`, l
                }
                handleNoHeadingsFound() {
                    const e = i("No headings were found on this page.", "elementor-pro");
                ...
                collapseBodyListener() {
                    ...
                    "desktop" === t || e.indexOf(t) >= e.indexOf(s) ? i || this.collapseBox() : i && this.expandBox()
                }
                onElementChange(e) {
