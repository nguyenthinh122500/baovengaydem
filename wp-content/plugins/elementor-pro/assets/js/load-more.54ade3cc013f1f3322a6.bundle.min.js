...
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([
    [985], {
        4098: (e, t, s) => {
            ...
            var n = o(s(2607));
            class LoopLoadMore extends n.default {
                getDefaultSettings() {
                    const e = super.getDefaultSettings();
                    return e.selectors.postsContainer = ".elementor-loop-container", e.selectors.postWrapperTag = ".e-loop-item", e.selectors.loadMoreButton = ".e-loop__load-more .elementor-button", e
                }
            }
            ...
            class LoadMore extends elementorModules.frontend.handlers.Base {
                ...
                handleSuccessFetch(e) {
                    ...
                    const t = this.getSettings("selectors"),
                        ...
                        o = e.querySelector(".e-load-more-anchor").getAttribute("data-next-page"),
                        n = [...s].reduce(((e, t) => e + t.outerHTML), "");
                    this.elements.postsContainer.insertAdjacentHTML("beforeend", n), this.elements.loadMoreAnchor.setAttribute("data-page", this.currentPage), this.elements.loadMoreAnchor.setAttribute("data-next-page", o), this.currentPage === this.maxPage && this.handleUiWhenNoPosts()
                }
                handlePostsQuery() {
